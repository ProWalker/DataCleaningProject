...
def find_outliers_quantile(data, feature, left=0.01, right=0.99):
    ...
    Возможности:
    * ручное управление границами выбросов в обе стороны
    Args:
        data (pandas.DataFrame): набор данных
        feature (str): имя признака, на основе которого происходит поиск выбросов
        left (float, optional): квантиль левой границы. По умолчанию 0.01.
        right (float, optional): квантиль правой границы. По умолчанию 0.99.
